...
import com.allana.newsapp.databinding.FragmentSearchNewsBinding
...
class SearchNewsFragment: Fragment(R.layout.fragment_search_news) {
    ...
    private fun showSnackbar(message: String) {
        view?.let { Snackbar.make(it, "An eror occurred $message", Snackbar.LENGTH_LONG).show() }
    }
    ...
    private val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val isTotalMoreThanVisible = totalItemCount >= BreakingNewsFragment.QUERY_PAGE_SIZE
